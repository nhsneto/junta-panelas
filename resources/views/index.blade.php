<x-layout>
    <section class="w-full flex flex-col justify-center items-center gap-y-10 sm:flex-row sm:gap-y-0 sm:gap-x-10 lg:justify-between">
        <img src="{{ url('img/pexels-fauxels-3184195-640.jpg') }}" alt="{{ __('People having lunch at a table') }}" class="w-full max-w-[385px] rounded-md drop-shadow-md sm:min-w-[385px] sm:max-w-[480px] lg:min-w-[480px] lg:max-w-[640px]">
        <div class="max-w-md">
