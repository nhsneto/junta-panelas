<x-layout>
    <section class="flex justify-between items-center gap-x-10">
        <div class="max-w-md">
            ...
            <a href="{{ url('/login') }}" class="mt-4 block bg-[#f0997d] text-xl text-black/50 font-bold text-center py-4 rounded-xl drop-shadow-md hover:brightness-110 active:brightness-100">Planejar Agora</a>
        </div>
